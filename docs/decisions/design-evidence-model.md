...
- Subjective A/B/C/D review must cite findings and semantic regions and cover
  routes, states, and viewports. Incomplete review cannot affect the displayed
  score. A pending critical deterministic finding prevents subjective input
  from lifting the blended score above the objective score.
