You are implementing Loop Factory spec `lf-0022`.

        Native adapter: `codex`
        Spec path: `/Users/omar/Documents/Projects/UIdetox/factory/specs/active/lf-0022-first-run-onboarding.md`
        Spec hash: `60f88ca61d5932c3f1cb948e3c57e6b6fe591845e871da7722884e6cd11726c3`
        ...
        - `python -m pytest -q tests/test_onboarding.py`
- `python -m pytest -q`
- `python -m compileall -q uidetox`
