...
| 052 | Finalize session branches outside the user worktree | P1 | M | — | DONE — independently reviewed; 1,480 tests pass; production +321 LOC; destructive original-worktree finalize path removed |
