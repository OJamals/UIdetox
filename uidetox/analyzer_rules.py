"""Static anti-pattern rule catalog."""

import re

# File extension groups shared by catalog entries.
...
RULES = [
    {
        "id": "TYPOGRAPHY_SLOP",
        "pattern": re.compile(
            r"\b(font-(inter|roboto|sans|arial|open-sans)|font-family:\s*(Inter|Roboto|Arial|System-ui))\b",
            re.IGNORECASE,
        ),
        "tier": "T1",
    ...
    },
    {
        "id": "SHADOW_SLOP",
        "pattern": re.compile(
            r"\b(shadow-2xl|shadow-3xl|shadow-\[0_\d+px)\b", re.IGNORECASE
        ),
        "tier": "T1",
        "exts": {".css", ".scss", ".tsx", ".jsx", ".html", ".svelte", ".vue"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"\b(stat-?card|metric-?card|dashboard-?hero|stats-?grid|kpi-?card)\b",
            re.IGNORECASE,
        ),
        "tier": "T3",
        "exts": {".tsx", ".jsx", ".html", ".svelte", ".vue"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"text-gray-[3-5]00.*?bg-(blue|purple|green|indigo|violet)-", re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx", ".html", ".svelte", ".vue"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"(?:bg-(white|gray|slate|zinc)-[12]00|bg-white)\b(?!.*dark:)",
            re.IGNORECASE,
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx", ".html", ".svelte", ".vue"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"\b(Supercharge|Revolutionize|Unlock the power|Seamlessly|Take your .* to the next level|Effortlessly)\b",
            re.IGNORECASE,
        ),
        "tier": "T2",
    ...
    },
    {
        "id": "EMOJI_HEAVY_SLOP",
        "pattern": re.compile(
            r"[\U0001f300-\U0001f9ff](?:.*[\U0001f300-\U0001f9ff]){5,}", re.DOTALL
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx", ".html", ".svelte", ".vue"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"(?:opacity-\d{1,2}|bg-.*?/\d{1,2})(?:.*(?:opacity-\d{1,2}|bg-.*?/\d{1,2})){4,}",
            re.DOTALL,
        ),
        "tier": "T2",
        "exts": _JSX_EXTS,
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"bg-clip-text.*?text-transparent|text-transparent.*?bg-clip-text",
    ...
    },
    {
        "id": "NEON_GLOW_SLOP",
        "pattern": re.compile(
            r"\b(shadow-\[0_0_|shadow-glow|shadow-neon|ring-.*glow|drop-shadow.*0_0_)\b",
            re.IGNORECASE,
        ),
        "tier": "T1",
        "exts": _FE_EXTS,
    ...
    },
    {
        "id": "PILL_BADGE_SLOP",
        "pattern": re.compile(
            r'rounded-full[^"]*(?:badge|tag|chip|label|pill)', re.IGNORECASE
        ),
        "tier": "T2",
        "exts": _JSX_EXTS,
    ...
    },
    {
        "id": "LOREM_IPSUM_SLOP",
        "pattern": re.compile(
            r"\b(lorem ipsum|dolor sit amet|consectetur adipiscing)\b", re.IGNORECASE
        ),
        "tier": "T1",
        "exts": _ALL_FE_EXTS,
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"\b(John Doe|Jane (?:Smith|Doe)|Acme (?:Corp|Inc)|SmartFlow|NexusAI)\b",
            re.IGNORECASE,
        ),
        "tier": "T2",
        "exts": _ALL_FE_EXTS,
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"\b(Next-Gen|Game[- ]?changer|Cutting[- ]?edge|\bDelve\b|\bTapestry\b|Elevate your|Unleash the)\b",
            re.IGNORECASE,
        ),
        "tier": "T2",
        "exts": _ALL_FE_EXTS,
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'<(?:button|a)\s[^>]*className=["\'][^"\']*["\']', re.IGNORECASE
        ),
        "tier": "T2",
        "exts": _JSX_EXTS,
    ...
    },
    {
        "id": "CENTER_BIAS_SLOP",
        "pattern": re.compile(
            r"text-center.*mx-auto|mx-auto.*text-center", re.IGNORECASE | re.DOTALL
        ),
        "tier": "T2",
        "exts": _JSX_EXTS,
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'class(?:Name)?=["\'][^"\']*border-(?:gray|slate|zinc|neutral|stone)-(?:200|300|700|800)(?!\/\d+)[^"\']*["\']',
            re.IGNORECASE,
        ),
        "tier": "T1",
        "exts": _JSX_EXTS,
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'class(?:Name)?=["\'][^"\']*(?:text-(?:sm|xs|base)[^"\']*leading-(?:none|tight)|leading-(?:none|tight)[^"\']*text-(?:sm|xs|base))[^"\']*["\']',
            re.IGNORECASE,
        ),
        "tier": "T1",
        "exts": _JSX_EXTS,
    ...
    },
    {
        "id": "RAW_COLOR_SLOP",
        "pattern": re.compile(
            r"(?:color|background-color):\s*(?:red|blue|green|purple|orange|yellow)\b\s*[;}]",
            re.IGNORECASE,
        ),
        "tier": "T1",
        "exts": _ALL_FE_EXTS,
    ...
    },
    {
        "id": "TODO_FIXME_SLOP",
        "pattern": re.compile(
            r"(?://|/\*|<!--)\s*(?:TODO|FIXME|HACK|XXX|TEMP)\b", re.IGNORECASE
        ),
        "tier": "T2",
        "exts": _ALL_FE_EXTS,
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"(?:margin|padding|gap|top|left|right|bottom|width|height):\s*\d{3,}px",
            re.IGNORECASE,
        ),
        "tier": "T2",
        "exts": {".css", ".scss", ".less"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'(?:src|href)=["\']https?://(?:unsplash\.com|images\.unsplash\.com|source\.unsplash\.com)',
            re.IGNORECASE,
        ),
        "tier": "T1",
        "exts": _ALL_FE_EXTS,
    ...
    # ──────────────────────────────────────────────
    {
        ...
        "pattern": re.compile(
            r'<(?:button|a)\b[^>]+aria-hidden=["\']true["\']', re.IGNORECASE
        ),
        "tier": "T1",
        "exts": {".tsx", ".jsx", ".html"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'aria-label=["\'](?:button|close|icon|link|image)["\']', re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx", ".html"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'<div\b[^>]+tabIndex=\{0\}|<div\b[^>]+tabindex="0"', re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx", ".html"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'<h[123][^>]*class(?:Name)?=["\'][^"\']*\buppercase\b', re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx", ".html"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"<[Bb]utton[^>]*>\s*(?:Submit|OK|Click here)\s*</[Bb]utton>", re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx", ".html"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'<(?:div|section|span)[^>]+role=["\']dialog["\']', re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx", ".html"},
    ...
    },
    {
        "id": "EMPTY_HREF_SLOP",
        "pattern": re.compile(
            r"""href=(?:"#"|'#'|"javascript:|'javascript:)""", re.IGNORECASE
        ),
        "tier": "T1",
        "exts": {".tsx", ".jsx", ".html"},
    ...
    # ──────────────────────────────────────────────
    {
        ...
        "pattern": re.compile(
            r"@media\s*\((?:max|min)-width:\s*\d+px\)", re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".css", ".scss", ".less"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"will-change:\s*(?:transform|opacity|all)", re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".css", ".scss", ".less"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"--[a-z][-a-z0-9]*:\s*oklch\([^)]*\s+0\s+", re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".css", ".scss", ".less"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"(?<!:root\s)background(?:-color)?:\s*(?:#fff(?:fff)?|white)\b",
            re.IGNORECASE,
        ),
        "tier": "T2",
        "exts": {".css", ".scss", ".less"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r":focus\s*\{[^}]*outline:\s*(?:none|0)\b", re.IGNORECASE
        ),
        "tier": "T1",
        "exts": {".css", ".scss", ".less"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"(?:body|html)\s*\{[^}]*overflow:\s*hidden", re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".css", ".scss", ".less"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"(?:html|body)\s*\{[^}]*font-size:\s*\d+px", re.IGNORECASE
        ),
        "tier": "T1",
        "exts": {".css", ".scss", ".less"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"(?:transition|animation):[^;]*!important", re.IGNORECASE
        ),
        "tier": "T1",
        "exts": {".css", ".scss", ".less"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"padding-(?:top|bottom):\s*(?:56\.25|75|66\.67|33\.33)%", re.IGNORECASE
        ),
        "tier": "T1",
        "exts": {".css", ".scss", ".less"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"font-family:\s*(?:'Inter'|Inter|'Roboto'|Roboto|'Open Sans'|'Montserrat'|Montserrat|'Poppins'|Poppins|'Lato'|Lato)\b",
            re.IGNORECASE,
        ),
        "tier": "T2",
        "exts": {".css", ".scss", ".less"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"grid-template-columns:\s*repeat\(\s*(?:[2-9]|\d{2,})\s*,", re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".css", ".scss", ".less"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'fill=["\'](?:#000000|#000|white|black)["\']', re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'class(?:Name)?=["\'][^"\']*outline-none[^"\']*["\']', re.IGNORECASE
        ),
        "tier": "T1",
        "exts": {".tsx", ".jsx"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'class(?:Name)?=["\'][^"\']*animate-[^"\']*["\']', re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'class(?:Name)?=["\'][^"\']*text-(?:xs|sm|base|lg|xl|2xl|3xl|4xl|5xl|6xl|7xl|8xl|9xl)[^"\']*["\']',
            re.IGNORECASE,
        ),
        "tier": "T1",
        "exts": {".tsx", ".jsx"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'class(?:Name)?=["\'][^"\']*font-(?:bold|medium|semibold|light|thin|normal|extrabold|black)[^"\']*["\']',
            re.IGNORECASE,
        ),
        "tier": "T1",
        "exts": {".tsx", ".jsx"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'class(?:Name)?=["\'][^"\']*(?:flex|block|inline)[^"\']*["\']',
            re.IGNORECASE,
        ),
        "tier": "T1",
        "exts": {".tsx", ".jsx"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"style=\{\{[^}]*(?:#[0-9a-fA-F]{3,6}|rgb\()[^}]*\}\}", re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"useState\s*\(\s*new\s+(?:Map|Set|Array)\s*\(", re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"interface\s+\w+(?:\s+extends\s+\w+)?\s*\{\s*\}", re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".tsx", ".ts"},
    ...
    },
    {
        "id": "FAKE_METRIC_SLOP",
        "pattern": re.compile(
            r"99\.9+%|10x\s+faster|\$\d+[KM]\+\s+saved|\d{1,3}x\s+(?:faster|more|better)",
            re.IGNORECASE,
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx", ".html"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"\.map\s*\(\s*\([^)]*,\s*(?:index|idx|i)\s*\)\s*=>\s*(?:[^)]*\bkey=\{(?:index|idx|i)\})",
            re.IGNORECASE,
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"addEventListener\s*\(\s*['\"](?:scroll|touchstart|touchmove|wheel)['\"]"
        ),
        "tier": "T2",
        "exts": {".tsx", ".ts", ".js"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"localStorage\.setItem\s*\(\s*['\"](?:token|password|secret|auth|jwt)['\"]",
            re.IGNORECASE,
        ),
        "tier": "T1",
        "exts": {".tsx", ".ts", ".js"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"(?:window\.)?location(?:\.href)?\s*=\s*[a-zA-Z_]\w*\s*(?:[+;]|$)",
            re.MULTILINE,
        ),
        "tier": "T1",
        "exts": {".tsx", ".ts", ".js"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"<h[123][^>]*>\s*(?:[A-Z][a-z]+\s+){3,}[A-Z][a-z]+\s*</h[123]>"
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx", ".html"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"<button\b[^>]*>(?:\s*<(?:svg|i)\b[^>]*>)", re.IGNORECASE
        ),
        "tier": "T1",
        "exts": {".tsx", ".jsx"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"\bhandle(?!Submit\b|Change\b|Click\b|Focus\b|Blur\b|Key)[A-Z][a-z]+(?:Click|Change|Submit|Press)\b"
        ),
        "tier": "T2",
        "exts": {".tsx", ".ts", ".js"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"(?:ThemeToggle|toggleDarkMode|DarkModeToggle|darkMode)", re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'<p\b[^>]*className=["\'][^"\']*text-center[^"\']*["\'][^>]*>[^<]{30,}',
            re.IGNORECASE,
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx"},
    ...
    },
    {
        ...
        "pattern": re.compile(
            r'(?:modal|Modal)(?![^"]*role=["\']dialog["\'])', re.IGNORECASE
        ),
        "tier": "T2",
        "exts": {".tsx", ".jsx"},
