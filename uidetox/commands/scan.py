...
def run(args: argparse.Namespace):
    ...
    print("    • If ANY issues remain, effective subjective is CAPPED at 80.")
    print("    • If objective < 95, effective subjective is CAPPED at 75.")
    print("    • If any T1 issue is pending, effective subjective is CAPPED at 70.")
